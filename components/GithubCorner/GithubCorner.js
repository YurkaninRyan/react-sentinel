...
import 'components/GithubCorner/GithubCorner.scss';

export default class GithubCorner extends Component {
  render() {
    return (
      <div>
        <a href="https://github.com/YurkaninRyan/react-sentinel" className="github-corner" aria-label="View source on Github">
          <svg
            width="80"
            height="80"
            viewBox="0 0 250 250"
